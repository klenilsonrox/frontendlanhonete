...
const page = () => {
  return (
    <div className="p-4 w-full mx-auto bg-[#F5F3EF] h-screen flex ">
       <div className='max-w-7xl w-full flex items-start justify-between flex-col lg:flex-row mx-auto mt-10'>
        <div className='top-10 animaLeft'>
         ...
         <p className='max-w-[600px]'>Na RX Burguer, acreditamos que cada hambúrguer conta uma história. Feitos com ingredientes frescos e de alta qualidade, nossos hambúrgueres são preparados na hora para oferecer a você uma experiência gastronômica única. Desde as combinações clássicas até as criações exclusivas da casa, cada mordida é uma celebração de sabor e paixão. Venha nos visitar e descubra porque a RX Burger é o destino favorito dos amantes de hambúrgueres!</p>
